...
#### [server](./apps/server) | [📖 文档](./apps/server/README.md)
...
#### [@meta-1/web-authub](./apps/web) | [📖 文档](./apps/web/README.md)
统一用户授权平台前端应用。
- 🔐 **用户认证** - 登录、注册、密码重置界面
- 👤 **用户管理** - 个人资料、账号设置、安全管理
...
### 应用文档
- [AuthHub Server](./apps/server/README.md) - 后端服务完整文档
...
详细配置说明请查看 [server 文档](./apps/server/README.md)
